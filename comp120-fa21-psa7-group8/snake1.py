...
Iteration 1:
Creates a window that contains three frames: one for the game grid (shown in red),
one for the game controls (shown in blue), and one for the score and time (shown in green).
